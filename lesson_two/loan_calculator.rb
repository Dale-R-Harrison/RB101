...
loop do
  ...
  loop do
    ...
    if valid_input(amount)
      ...
      prompt "Sorry, amount of loan must be a positive number. Please try again."
    end
  end
  ...
  loop do
    ...
    if valid_input(interest)
      ...
      prompt "You must have an APR of 0% or more. Please try again."
    end
  end
  ...
  loop do
    ...
    if valid_input(years)
      ...
      "Most enter a positive number of years. Please try again."
    end
  end


  prompt "Thank you! Calculating now!"
  monthly_payment = calculatate_monthly_payment(amount, interest, total_months).to_f.round(2)

  prompt "Your total monthly payment will be #{monthly_payment}."
